...
public final class As2Message extends Table {
  public static As2Message getRootAsAs2Message(ByteBuffer _bb) {
    return getRootAsAs2Message(_bb, new As2Message());
  }

  public static As2Message getRootAsAs2Message(ByteBuffer _bb, As2Message obj) {
  ...
  public As2Message __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public ByteBuffer protocolInByteBuffer(ByteBuffer _bb) {
  ...
  public ByteBuffer contentDispositionAsByteBuffer() {
    return __vector_as_bytebuffer(16, 1);
  }

  public ByteBuffer contentDispositionInByteBuffer(ByteBuffer _bb) {
  ...
  public static void startAs2Message(FlatBufferBuilder builder) {
    builder.startObject(10);
  }
  ...
  public static void addProtocol(FlatBufferBuilder builder, int protocolOffset) {
    builder.addOffset(4, protocolOffset, 0);
  }

  public static void addContentType(FlatBufferBuilder builder, int contentTypeOffset) {
    builder.addOffset(5, contentTypeOffset, 0);
  }

  public static void addContentDisposition(FlatBufferBuilder builder, int contentDispositionOffset) {
    builder.addOffset(6, contentDispositionOffset, 0);
  }

  public static void addHeaders(FlatBufferBuilder builder, int headersOffset) {
    builder.addOffset(7, headersOffset, 0);
  }
  ...
  public static void addAttributes(FlatBufferBuilder builder, int attributesOffset) {
    builder.addOffset(8, attributesOffset, 0);
  }
  ...
  public static void addData(FlatBufferBuilder builder, int dataOffset) {
    builder.addOffset(9, dataOffset, 0);
  }
