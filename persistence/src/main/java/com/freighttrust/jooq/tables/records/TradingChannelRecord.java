...
public class TradingChannelRecord extends UpdatableRecordImpl<TradingChannelRecord> implements Record10<String, String, String, String, String, String, String, String, String, String> {

    private static final long serialVersionUID = 590342276;
    ...
    /**
     * Setter for <code>public.trading_channel.sender_id_x509_alias</code>.
     */
    public TradingChannelRecord setSenderIdX509Alias(String value) {
        set(2, value);
        return this;
    }

    /**
     * Getter for <code>public.trading_channel.sender_id_x509_alias</code>.
     */
    public String getSenderIdX509Alias() {
        return (String) get(2);
    }

    /**
     * Setter for <code>public.trading_channel.recipient_id_x509_alias</code>.
     */
    public TradingChannelRecord setRecipientIdX509Alias(String value) {
        set(3, value);
        return this;
    }

    /**
     * Getter for <code>public.trading_channel.recipient_id_x509_alias</code>.
     */
    public String getRecipientIdX509Alias() {
        return (String) get(3);
    }
    ...
    public Field<String> field3() {
        return TradingChannel.TRADING_CHANNEL.SENDER_ID_X509_ALIAS;
    }

    @Override
    public Field<String> field4() {
        return TradingChannel.TRADING_CHANNEL.RECIPIENT_ID_X509_ALIAS;
    }
    ...
    public String component3() {
        return getSenderIdX509Alias();
    }

    @Override
    public String component4() {
        return getRecipientIdX509Alias();
    }
    ...
    public TradingChannelRecord value3(String value) {
        setSenderIdX509Alias(value);
        return this;
    }

    @Override
    public TradingChannelRecord value4(String value) {
        setRecipientIdX509Alias(value);
        return this;
    }
    ...
    @Override
    public TradingChannelRecord value9(String value) {
    ...
    @Override
    public TradingChannelRecord values(String value1, String value2, String value3, String value4, String value5, String value6, String value7, String value8, String value9, String value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TradingChannelRecord(String senderId, String recipientId, String senderIdX509Alias, String recipientIdX509Alias, String protocol, String as2Url, String as2MdnTo, String as2MdnOptions, String encryptionAlgorithm, String signingAlgorithm) {
        super(TradingChannel.TRADING_CHANNEL);

        set(0, senderId);
        set(1, recipientId);
        set(2, senderIdX509Alias);
        set(3, recipientIdX509Alias);
        set(4, protocol);
        set(5, as2Url);
        set(6, as2MdnTo);
        set(7, as2MdnOptions);
        set(8, encryptionAlgorithm);
        set(9, signingAlgorithm);
    }
}
