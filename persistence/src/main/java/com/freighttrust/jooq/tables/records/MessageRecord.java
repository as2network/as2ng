...
public class MessageRecord extends UpdatableRecordImpl<MessageRecord> implements Record8<UUID, Long, String, String, String, Boolean, Boolean, String> {

    private static final long serialVersionUID = -812338441;
    ...
    /**
     * Setter for <code>public.message.signature_id</code>.
     */
    public MessageRecord setSignatureId(Long value) {
        set(1, value);
        return this;
    }

    /**
     * Getter for <code>public.message.signature_id</code>.
     */
    ...
    /**
     * Setter for <code>public.message.mic</code>.
     */
    public MessageRecord setMic(String value) {
        set(4, value);
        return this;
    }

    /**
     * Getter for <code>public.message.mic</code>.
     */
    ...
    @Override
    public Row8<UUID, Long, String, String, String, Boolean, Boolean, String> valuesRow() {
    ...
    public Field<Long> field2() {
        return Message.MESSAGE.SIGNATURE_ID;
    }
    ...
    @Override
    public MessageRecord values(UUID value1, Long value2, String value3, String value4, String value5, Boolean value6, Boolean value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MessageRecord(UUID requestId, Long signatureId, String encryptionAlgorithm, String compressionAlgorithm, String mic, Boolean isMdnRequested, Boolean isMdnAsync, String receiptDeliveryOption) {
        super(Message.MESSAGE);

        set(0, requestId);
        set(1, signatureId);
        set(2, encryptionAlgorithm);
        set(3, compressionAlgorithm);
        set(4, mic);
        set(5, isMdnRequested);
        set(6, isMdnAsync);
        set(7, receiptDeliveryOption);
    }
}
