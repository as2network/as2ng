...
public class MessageRecord extends UpdatableRecordImpl<MessageRecord> implements Record7<UUID, String, String, String, Boolean, Boolean, String> {
    ...
    private static final long serialVersionUID = -505886923;
     ...
     */
    public MessageRecord(UUID requestId, String encryptionAlgorithm, String compressionAlgorithm, String mic, Boolean isMdnRequested, Boolean isMdnAsync, String receiptDeliveryOption) {
        super(Message.MESSAGE);
