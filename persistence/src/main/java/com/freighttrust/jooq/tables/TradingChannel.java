...
public class TradingChannel extends TableImpl<TradingChannelRecord> {
    ...
    private static final long serialVersionUID = 1203659517;
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.TRADING_CHANNEL_PKEY, Indexes.TRADING_CHANNEL_SENDER_AS2_IDENTIFIER_RECIPIENT_AS2_IDENTIF_KEY, Indexes.TRADING_CHANNEL_SENDER_ID_RECIPIENT_ID_KEY);
    }
