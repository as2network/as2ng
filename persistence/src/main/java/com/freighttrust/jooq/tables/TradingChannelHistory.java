...
public class TradingChannelHistory extends TableImpl<TradingChannelHistoryRecord> {
    ...
    private static final long serialVersionUID = 583390593;
     ...
     */
    public final TableField<TradingChannelHistoryRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.trading_channel_history.name</code>.
     */
    public final TableField<TradingChannelHistoryRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>public.trading_channel_history.sender_id</code>.
     */
    public final TableField<TradingChannelHistoryRecord, Long> SENDER_ID = createField(DSL.name("sender_id"), org.jooq.impl.SQLDataType.BIGINT, this, "");
     ...
     */
    public final TableField<TradingChannelHistoryRecord, String> RECIPIENT_AS2_IDENTIFIER = createField(DSL.name("recipient_as2_identifier"), org.jooq.impl.SQLDataType.VARCHAR(64), this, "");
