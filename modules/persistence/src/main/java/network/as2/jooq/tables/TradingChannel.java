...
public class TradingChannel extends TableImpl<TradingChannelRecord> {
     ...
     */
    public final TableField<TradingChannelRecord, TradingChannelType> TYPE = createField(DSL.name("type"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(network.as2.jooq.enums.TradingChannelType.class), this, "");
