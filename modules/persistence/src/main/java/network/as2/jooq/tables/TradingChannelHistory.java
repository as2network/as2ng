...
import network.as2.jooq.tables.records.TradingChannelHistoryRecord;
...
public class TradingChannelHistory extends TableImpl<TradingChannelHistoryRecord> {
     ...
     */
    public final TableField<TradingChannelHistoryRecord, TradingChannelType> TYPE = createField(DSL.name("type"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(network.as2.jooq.enums.TradingChannelType.class), this, "");
