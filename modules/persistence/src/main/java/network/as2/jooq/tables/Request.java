...
public class Request extends TableImpl<RequestRecord> {
     ...
     */
    public final TableField<RequestRecord, RequestType> TYPE = createField(DSL.name("type"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(network.as2.jooq.enums.RequestType.class), this, "");
