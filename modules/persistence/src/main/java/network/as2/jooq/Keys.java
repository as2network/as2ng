...
import network.as2.jooq.tables.records.FlywaySchemaHistoryRecord;
...
public class Keys {
    ...
    public static final ForeignKey<MessageRecord, FileRecord> MESSAGE__MESSAGE_FILE_ID_FKEY = Internal.createForeignKey(Message.MESSAGE, DSL.name("message_file_id_fkey"), new TableField[] { Message.MESSAGE.FILE_ID }, Keys.FILE_PKEY, new TableField[] { File.FILE.ID }, true);
