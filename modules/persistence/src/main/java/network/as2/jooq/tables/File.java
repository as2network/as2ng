...
public class File extends TableImpl<FileRecord> {
     ...
     */
    public final TableField<FileRecord, FileProvider> PROVIDER = createField(DSL.name("provider"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(network.as2.jooq.enums.FileProvider.class), this, "");
