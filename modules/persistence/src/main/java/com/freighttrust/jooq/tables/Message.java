...
public class Message extends TableImpl<MessageRecord> {
     ...
     */
    public final TableField<MessageRecord, UUID> REQUEST_ID = createField(DSL.name("request_id"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>public.message.encryption_algorithm</code>.
     */
    public final TableField<MessageRecord, String> ENCRYPTION_ALGORITHM = createField(DSL.name("encryption_algorithm"), SQLDataType.VARCHAR(32), this, "");
     ...
     */
    public final TableField<MessageRecord, String[]> MICS = createField(DSL.name("mics"), SQLDataType.VARCHAR(512).getArrayDataType(), this, "");
