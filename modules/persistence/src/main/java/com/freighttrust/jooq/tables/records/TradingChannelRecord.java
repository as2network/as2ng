...
public class TradingChannelRecord extends UpdatableRecordImpl<TradingChannelRecord> implements Record10<Long, String, Long, String, Long, Long, String, String, Long, TsTzRange> {
     ...
     */
    public TradingChannelRecord(Long id, String name, Long senderId, String senderAs2Identifier, Long senderKeyPairId, Long recipientId, String recipientAs2Identifier, String recipientMessageUrl, Long recipientKeyPairId, TsTzRange validity) {
        super(TradingChannel.TRADING_CHANNEL);
