...
public class TradingChannelRecord extends UpdatableRecordImpl<TradingChannelRecord> implements Record8<Long, String, Long, String, Long, String, String, TsTzRange> {

    private static final long serialVersionUID = -1267559862;
    ...
    @Override
    public TradingChannelRecord value8(TsTzRange value) {
        setValidity(value);
        return this;
    }

    @Override
    public TradingChannelRecord values(Long value1, String value2, Long value3, String value4, Long value5, String value6, String value7, TsTzRange value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TradingChannelRecord(Long id, String name, Long senderId, String senderAs2Identifier, Long recipientId, String recipientAs2Identifier, String recipientMessageUrl, TsTzRange validity) {
        super(TradingChannel.TRADING_CHANNEL);
