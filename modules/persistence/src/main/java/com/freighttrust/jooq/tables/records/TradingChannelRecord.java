...
public class TradingChannelRecord extends UpdatableRecordImpl<TradingChannelRecord> implements Record10<Long, String, Long, String, Long, Long, String, String, Long, TsTzRange> {

    private static final long serialVersionUID = 377476709;
    ...
    /**
     * Setter for <code>public.trading_channel.sender_signature_key_pair_id</code>.
     */
    public TradingChannelRecord setSenderSignatureKeyPairId(Long value) {
        set(4, value);
        return this;
    }

    /**
     * Getter for <code>public.trading_channel.sender_signature_key_pair_id</code>.
     */
    ...
    /**
     * Setter for <code>public.trading_channel.recipient_encryption_key_pair_id</code>.
     */
    public TradingChannelRecord setRecipientEncryptionKeyPairId(Long value) {
        set(8, value);
        return this;
    }

    /**
     * Getter for <code>public.trading_channel.recipient_encryption_key_pair_id</code>.
     */
    ...
    public Field<Long> field5() {
        return TradingChannel.TRADING_CHANNEL.SENDER_SIGNATURE_KEY_PAIR_ID;
    }
    ...
    public Field<Long> field9() {
        return TradingChannel.TRADING_CHANNEL.RECIPIENT_ENCRYPTION_KEY_PAIR_ID;
    }
    ...
    @Override
    public TradingChannelRecord value10(TsTzRange value) {
        setValidity(value);
        return this;
    }

    @Override
    public TradingChannelRecord values(Long value1, String value2, Long value3, String value4, Long value5, Long value6, String value7, String value8, Long value9, TsTzRange value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TradingChannelRecord(Long id, String name, Long senderId, String senderAs2Identifier, Long senderSignatureKeyPairId, Long recipientId, String recipientAs2Identifier, String recipientMessageUrl, Long recipientEncryptionKeyPairId, TsTzRange validity) {
        super(TradingChannel.TRADING_CHANNEL);
