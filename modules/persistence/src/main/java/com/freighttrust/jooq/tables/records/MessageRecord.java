...
public class MessageRecord extends UpdatableRecordImpl<MessageRecord> implements Record9<UUID, String, Long, Long, String, String[], Boolean, Boolean, String> {
    ...
    @Override
    public Row9<UUID, String, Long, Long, String, String[], Boolean, Boolean, String> valuesRow() {
    ...
    @Override
    public MessageRecord values(UUID value1, String value2, Long value3, Long value4, String value5, String[] value6, Boolean value7, Boolean value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MessageRecord(UUID requestId, String encryptionAlgorithm, Long encryptionKeyPairId, Long signatureKeyPairId, String compressionAlgorithm, String[] mics, Boolean isMdnRequested, Boolean isMdnAsync, String receiptDeliveryOption) {
        super(Message.MESSAGE);
