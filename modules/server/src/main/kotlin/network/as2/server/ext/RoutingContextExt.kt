...
import network.as2.server.domain.toMimeBodyPart
...
val RoutingContext.reportingUserAgent: String
  get() = network.as2.server.BuildConfig.version.take(16)
  ...
  with(as2Context) {
    DispositionNotification()
      .apply {
        ...
        digestAlgorithm = dispositionNotificationOptions?.firstMICAlg?.id
      }
  }
